...
use hazard::{Shield, collect, retire};
...
mod sync {
    ...
    use hazard::test::loom::sync::Arc;
    use hazard::test::loom::sync::atomic::Ordering::*;
    use hazard::test::loom::sync::atomic::{AtomicPtr, AtomicUsize};
    use hazard::test::loom::{model, thread};
    use hazard::*;
